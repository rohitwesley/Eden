...
public class InteractableEditor : EditorWithSubEditors<ConditionCollectionEditor, ConditionCollection>
{
    ...
    private SerializedProperty interactionAgentIdProperty;   // Represents the ReactionCollection which is used if none of the ConditionCollections are.
    ...
    private const string interactablePropInteractionAgentIdName = "interactionAgentId";
    ...
    private void OnEnable ()
    {
        ...
        interactionAgentIdProperty = serializedObject.FindProperty(interactablePropInteractionAgentIdName);
    ...
    public override void OnInspectorGUI ()
    {
        ...
        EditorGUILayout.PropertyField (interactionAgentIdProperty);
