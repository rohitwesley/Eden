...
public class Interactable : MonoBehaviour
{
    ...
    public InteractionManager agent;
    public AgentType interactionAgentId;
    ...
    public void Interact ()
    {
        ...
        // Debug.Log("Default Reaction PickUp");

    }

    void OnTriggerEnter(Collider other) 
    {
        if(other.gameObject.GetComponent<AgentInfo>() != null && other.gameObject.GetComponent<AgentInfo>().AgentSettings != null)
        {
            // Debug.Log("Trigger Object :" + other.gameObject.GetComponent<AgentInfo>().AgentSettings.AgentId);
            //Trigger Interaction for specific type of agent
            if (other.gameObject.GetComponent<AgentInfo>().AgentSettings.AgentId == interactionAgentId)
            {
                // Debug.Log(this.gameObject.GetComponent<AgentInfo>().AgentSettings.AgentId + " Object PickedUp");
                
                Interact();
                // agent.OnInteractableClick(this);
            }
